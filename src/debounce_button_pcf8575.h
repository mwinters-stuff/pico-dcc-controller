...
// copied from https://github.com/madskjeldgaard/PicoDebounceButton/blob/main/include/PicoDebounceButton/PicoDebounceButton.hpp
#include <cstdint>
...
public:
  ...
  explicit PCF8575DebounceButton(PCF8575 *pcf8575,
                              uint8_t pin,
  ...
  auto update()
  {
    bool currentState = mInvert ? !mPCF8575->read(mPin) : mPCF8575->read(mPin);
...
private:
  // The PCF8575 pointer to the PCF8575 device.
  PCF8575 *mPCF8575;
  const uint8_t mPin {};
  uint16_t mInterval {};
  bool mState;
